...
/**
 * Resourceful controller for interacting with replacements
 */
class ReplacementController {
  /**
   * Show a list of all replacements.
   * GET replacements
   *
   * @param {object} ctx
